using Common.Base.Library.Barcode.GenratorPackage;
using Common.Base.Library.Barcode.GenratorPackage.Symbologies;
using System;
...
{
    public class Genrator :IDisposable,IBarcodeGenrator
    {
        #region Variables
        private IBarcodeConstants ibarcode = new Blank();
        ...
        public Genrator(string data)
        {
            //constructor
            this.Raw_Data = data;
        }//Barcode

        public Genrator(string data, TYPE iType)
        {
            this.Raw_Data = data;
