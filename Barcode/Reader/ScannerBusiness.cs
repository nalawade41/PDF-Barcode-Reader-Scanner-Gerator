...
namespace Common.Base.Library.Barcode.ReaderPackage
{
    class ScannerBusiness
    {
        ...
        protected static void GetBarPatterns(ref HistogramResult hist, out StringBuilder sbCode39Pattern, out StringBuilder sbEANPattern)
        {
        ...
        protected static HistogramResult VerticalHistogram(Bitmap bmp, int start, int end, ScanDirection direction)
        {
            ...
            //For more distorted lines set threshold higher
            if (retVal.threshold < 149)
                retVal.threshold = 150;
        ...
        protected static string ParseCode39(StringBuilder sbPattern)
        {
        ...
        /// <returns>Pipe-separated list of barcodes, empty string if none were detected</returns>
        protected static string ParseEAN(StringBuilder sbPattern)
        {
        ...
        /// <returns>Pipe-separated list of barcodes, empty string if none were detected</returns>
        protected static string ParseCode128(StringBuilder sbPattern)
        {
        ...
        protected static StringBuilder ReversePattern(StringBuilder sbPattern)
        {
